...
try:
    ...
    iframe {display:none !important; height:0 !important; visibility:hidden !important; border:none !important;}
    div:has(> iframe) {display:none !important;}
    </style>
    """, unsafe_allow_html=True)
    
    # Injection manifest externe + icones pour remplacer logo rouge Streamlit
    _pwa_wrapper_html = f"""
    <link rel="icon" type="image/png" sizes="512x512" href="data:image/png;base64,{_JT_VRAI_LOGO_COMPLET_B64}">
    <link rel="icon" type="image/png" sizes="192x192" href="data:image/png;base64,{_JT_VRAI_LOGO_COMPLET_B64}">
    <link rel="apple-touch-icon" sizes="180x180" href="data:image/png;base64,{_JT_VRAI_LOGO_COMPLET_B64}">
    <link rel="apple-touch-icon" sizes="512x512" href="data:image/png;base64,{_JT_VRAI_LOGO_COMPLET_B64}">
    <meta name="apple-mobile-web-app-title" content="JT-AGRITECH">
    <meta name="application-name" content="JT-AGRITECH">
    <meta name="theme-color" content="#225522">
    <meta name="msapplication-TileImage" content="data:image/png;base64,{_JT_VRAI_LOGO_COMPLET_B64}">
    <meta name="msapplication-TileColor" content="#225522">
    """
    st.markdown(_pwa_wrapper_html, unsafe_allow_html=True)
    
    # Wrapper PWA externe JavaScript robuste - remplace manifest Streamlit par manifest JT
    _pwa_wrapper_js = """
    <script>
    (function() {
        try {
            // Supprime ancien manifest Streamlit
            var oldManifests = document.querySelectorAll('link[rel="manifest"]');
            oldManifests.forEach(function(m) { m.remove(); });
            
            // Cree nouveau manifest JT-AGRITECH avec vrai logo
            var manifestData = {
                "name": "JT-AGRITECH",
                "short_name": "JT-AGRITECH",
                "description": "Au service des paysans - Gestion des eleveurs d'HANNETONS ET d'ESCARGOTS",
                "start_url": ".",
                "display": "standalone",
                "background_color": "#225522",
                "theme_color": "#225522",
                "icons": [
                    {"src": "data:image/png;base64,__B64__", "sizes": "512x512", "type": "image/png", "purpose": "any maskable"},
                    {"src": "data:image/png;base64,__B64__", "sizes": "192x192", "type": "image/png", "purpose": "any maskable"},
                    {"src": "data:image/png;base64,__B64__", "sizes": "512x512", "type": "image/png", "purpose": "any"}
                ]
            };
            ...
            // Force icone dans tous les endroits
                        // Force pour tablette - remplace toutes tailles icones Streamlit
            var allIconSizes = [72, 96, 128, 144, 152, 192, 384, 512];
            allIconSizes.forEach(function(size) {
                var link = document.createElement('link');
                link.rel = 'icon';
                link.type = 'image/png';
                link.sizes = size + 'x' + size;
                link.href = "data:image/png;base64,";
                document.head.appendChild(link);
                
                var appleLink = document.createElement('link');
                appleLink.rel = 'apple-touch-icon';
                appleLink.sizes = size + 'x' + size;
                appleLink.href = "data:image/png;base64,";
                document.head.appendChild(appleLink);
            });
            
            var iconLinks = document.querySelectorAll('link[rel*="icon"]');
            iconLinks.forEach(function(l) {
                if (l.href.includes('streamlit') || l.href.includes('favicon')) {
                    l.href = "data:image/png;base64,__B64__";
                }
            });
            
            // Apple touch icon
            var appleIcons = document.querySelectorAll('link[rel="apple-touch-icon"]');
            appleIcons.forEach(function(a) {
                a.href = "data:image/png;base64,__B64__";
            });
            
            // Meta theme
            var themeMeta = document.querySelector('meta[name="theme-color"]');
            if (themeMeta) themeMeta.content = "#225522";
            
            console.log("✅ Wrapper PWA externe JT-AGRITECH actif - Logo rouge Streamlit remplace par vrai logo JT");
        } catch(e) {
            console.log("Wrapper PWA erreur:", e);
        }
    })();
    </script>
    """.replace("__B64__", _JT_VRAI_LOGO_COMPLET_B64)
    
    st.markdown(_pwa_wrapper_js, unsafe_allow_html=True)
    
    # Sauve manifest.json externe dans meme dossier que web.py pour wrapper
    try:
        ...
        _manifest_external = {
            ...
            "theme_color": "#225522",
            "icons": [
                {"src": "data:image/png;base64," + _JT_VRAI_LOGO_COMPLET_B64, "sizes": "512x512", "type": "image/png", "purpose": "any maskable"},
                {"src": "data:image/png;base64," + _JT_VRAI_LOGO_COMPLET_B64, "sizes": "192x192", "type": "image/png", "purpose": "any maskable"}
            ]
        }
        _manifest_path = APP_DIR / "manifest.json"
        _manifest_path.write_text(_json.dumps(_manifest_external, indent=2), encoding="utf-8")
    except:
        pass
...
if not st.session_state.entered_app:
    ...
    @keyframes pulse {0% {transform:scale(1); box-shadow:0 6px 20px rgba(34,85,34,0.3);} 50% {transform:scale(1.05); box-shadow:0 10px 30px rgba(34,85,34,0.4);} 100% {transform:scale(1); box-shadow:0 6px 20px rgba(34,85,34,0.3);}}
    @keyframes shimmer {0% {background-position:-1000px 0;} 100% {background-position:1000px 0;}}
    @keyframes gradientShift {0% {background-position:0% 50%;} 50% {background-position:100% 50%;} 100% {background-position:0% 50%;}}
    .welcome-container {animation: fadeInUp 1s ease-out;}
    .welcome-logo {animation: float 3s ease-in-out infinite; text-align:center; margin:20px 0; background:white; border-radius:50%; padding:20px; box-shadow:0 8px 24px rgba(34,85,34,0.15); display:inline-block;}
    .welcome-title {animation: fadeInUp 1.2s ease-out 0.3s both; text-align:center; background: linear-gradient(90deg, #225522, #8fbc5f, #225522); background-size:200% 200%; -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; font-size:44px; font-weight:900; margin:20px 0; animation: gradientShift 3s ease infinite, fadeInUp 1.2s ease-out 0.3s both;}
    .welcome-subtitle {animation: fadeInUp 1.2s ease-out 0.6s both; text-align:center; color:#5a7a3a; font-size:24px; font-weight:800; letter-spacing:1px;}
    .welcome-card-new {animation: fadeInUp 1.2s ease-out 0.9s both; background: linear-gradient(135deg, #ffffff 0%, #f4f9ec 100%); border-radius:25px; padding:35px; margin:25px 0; box-shadow:0 12px 40px rgba(34,85,34,0.12); border:2px solid #8fbc5f; text-align:center; position:relative; overflow:hidden;}
    .welcome-card-new::before {content:""; position:absolute; top:0; left:0; right:0; height:5px; background: linear-gradient(90deg, #225522, #8fbc5f); }
    .welcome-stats-new {display:flex; justify-content:space-around; margin:25px 0; animation: fadeInUp 1.2s ease-out 1.2s both; gap:15px;}
    .welcome-stat-new {text-align:center; background: linear-gradient(135deg, white 0%, #f9fdf2 100%); border-radius:20px; padding:20px; box-shadow:0 6px 16px rgba(34,85,34,0.1); min-width:110px; border:2px solid #e0e8d5; transition:transform 0.3s;}
    .welcome-stat-new:hover {transform:translateY(-5px); box-shadow:0 10px 24px rgba(34,85,34,0.15);}
    .welcome-stat-number-new {font-size:32px; font-weight:900; background: linear-gradient(135deg, #225522, #8fbc5f); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text;}
    .welcome-stat-label-new {font-size:11px; color:#5a7a3a; font-weight:800; text-transform:uppercase; margin-top:8px; letter-spacing:0.5px;}
    .eleveur-card-new {background: linear-gradient(135deg, white 0%, #fcfff7 100%); border-radius:18px; padding:18px; box-shadow:0 6px 16px rgba(34,85,34,0.08); border-left:6px solid #225522; margin-bottom:12px; transition:all 0.3s; position:relative; overflow:hidden;}
    .eleveur-card-new:hover {transform:translateY(-3px); box-shadow:0 10px 24px rgba(34,85,34,0.15); border-left-color:#8fbc5f;}
    .eleveur-card-new::after {content:"🌿"; position:absolute; right:15px; top:50%; transform:translateY(-50%); font-size:24px; opacity:0.15;}
    </style>
    """, unsafe_allow_html=True)
    ...
    try:
        fichier_stats = APP_DIR / "eleveurs.xlsx"
        if fichier_stats.exists():
            import pandas as _pd
            _df_stats = _pd.read_excel(fichier_stats)
            _df_stats = _df_stats.fillna("")
            total_e = len(_df_stats)
            total_b = int(_df_stats["bacs"].sum()) if "bacs" in _df_stats.columns and not _df_stats.empty else 0
            total_p = len(_df_stats[_df_stats["statut_paiement"]=="Payé"]) if "statut_paiement" in _df_stats.columns and not _df_stats.empty else 0
        else:
            total_e = 8
            total_b = 69
            total_p = 3
    ...
    st.markdown(f"""
    <div class="welcome-stats-new">
        <div class="welcome-stat-new">
            <div class="welcome-stat-number-new">{total_e}</div>
            <div class="welcome-stat-label-new">Éleveurs</div>
        </div>
        <div class="welcome-stat-new">
            <div class="welcome-stat-number-new">{total_b}</div>
            <div class="welcome-stat-label-new">Bacs</div>
        </div>
        <div class="welcome-stat-new">
            <div class="welcome-stat-number-new">{total_p}</div>
            <div class="welcome-stat-label-new">Payés</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if "BIENVENUE" in menu or "ACCUEIL" in menu:
 ...
 try:
  ...
  with tab_escargots:
   ...
   try:
    total_e = len(df_escargots)
    total_b = int(df_escargots["bacs"].sum()) if "bacs" in df.columns and not df.empty else 0
    total_paye = len(df_escargots[df_escargots["statut_paiement"]=="Payé"]) if "statut_paiement" in df.columns and not df.empty else 0
    total_livre = len(df_escargots[df_escargots["statut_livraison"]=="Livré"]) if "statut_livraison" in df.columns and not df.empty else 0
   except:
    total_e = 8
    total_b = 69
    total_paye = 3
   ...
   if not df_escargots.empty and "nom" in df_escargots.columns:
    cols = st.columns(2)
    for idx, row in df_escargots.iterrows():
     with cols[idx % 2]:
      nom = f"{str(row.get('nom','')).upper()} {str(row.get('prenom',''))}"
    ...
    with st.expander("Tableau complet escargots"):
     st.dataframe(df_escargots.fillna(""), use_container_width=True)
  
  # TOUT DIFFERENT POUR ESCARGOTS - Finances et bacs differents de hannetons
  st.divider()
  st.markdown("### 💰 Finances Escargots - TOUT DIFFERENT de Hannetons")
  if not df_fin_escargots.empty:
   c1,c2,c3 = st.columns(3)
   with c1:
    total_paye_e = int(df_fin_escargots["montant_paye"].sum()) if "montant_paye" in df_fin_escargots.columns else 0
    st.metric("💰 Total Payé Escargots", f"{total_paye_e:,} FCFA")
   with c2:
    total_du_e = int(df_fin_escargots["montant_du"].sum()) if "montant_du" in df_fin_escargots.columns else 0
    st.metric("💳 Total Dû Escargots", f"{total_du_e:,} FCFA")
   with c3:
    kg_vendus = int(df_fin_escargots["kg_vendus"].sum()) if "kg_vendus" in df_fin_escargots.columns else 0
    st.metric("⚖️ Kg Vendus Escargots", f"{kg_vendus} kg")
   
   with st.expander("📊 Détails finances escargots - DIFFERENTS"):
    st.dataframe(df_fin_escargots.fillna(""), use_container_width=True)
  else:
   st.info("Finances escargots - Tout different de hannetons")
  
  st.markdown("### 📦 Bacs Escargots - TOUT DIFFERENT de Hannetons")
  if not df_bacs_escargots.empty:
   st.dataframe(df_bacs_escargots.fillna(""), use_container_width=True)
   st.caption("Bacs escargots: humidité, calcium - DIFFERENT de substrat/temperature hannetons")
  
  st.success("✅ TOUT DIFFERENT - 🪲 Hannetons: NDOKO,MBARGA... finances hannetons | 🐌 Escargots: ETOUDI,BIYA... finances escargots DIFFERENTES - Section hanneton INTACTE")
