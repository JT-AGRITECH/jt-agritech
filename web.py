...
if not st.session_state.entered_app:
    ...
    .welcome-container {animation: fadeIn 1s ease-out;}
    .welcome-logo {animation: float 3s ease-in-out infinite; text-align:center; margin:20px 0;}
    .welcome-title {animation: fadeIn 1.2s ease-out 0.3s both; text-align:center; color:#225522; font-size:42px; font-weight:900; margin:20px 0;}
    .welcome-subtitle {animation: fadeIn 1.2s ease-out 0.6s both; text-align:center; color:#5a7a3a; font-size:22px; font-weight:700;}
    .welcome-card {animation: fadeIn 1.2s ease-out 0.9s both; background: linear-gradient(135deg, #f4f9ec 0%, #eaf3de 100%); border-radius:20px; padding:30px; margin:20px 0; box-shadow:0 8px 32px rgba(34,85,34,0.12); border:2px solid #e0e8d5; text-align:center;}
    .welcome-stats {display:flex; justify-content:space-around; margin:20px 0; animation: fadeIn 1.2s ease-out 1.2s both;}
    .welcome-stat {text-align:center; background:white; border-radius:15px; padding:15px; box-shadow:0 4px 12px rgba(34,85,34,0.08); min-width:100px;}
    .welcome-stat-number {font-size:28px; font-weight:800; color:#225522;}
    .welcome-stat-label {font-size:12px; color:#5a7a3a; font-weight:700; text-transform:uppercase; margin-top:5px;}
    </style>
    """, unsafe_allow_html=True)
    ...
    <div class="welcome-stats">
        <div class="welcome-stat">
            <div class="welcome-stat-number">{total_e}</div>
            <div class="welcome-stat-label">Éleveurs</div>
        </div>
        <div class="welcome-stat">
            <div class="welcome-stat-number">{total_b}</div>
            <div class="welcome-stat-label">Bacs</div>
        </div>
        <div class="welcome-stat">
            <div class="welcome-stat-number">{total_p}</div>
            <div class="welcome-stat-label">Payés</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
