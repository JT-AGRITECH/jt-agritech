...
# FIX: cree logo.png AVANT icone pour remplacer Streamlit
try:
    import base64 as _b64fix
    _lp_fix = APP_DIR / "logo.png"
    if not _lp_fix.exists():
        try:
            _lp_fix.write_bytes(_b64fix.b64decode(_jt_icon_b64))
        except:
            pass
except:
    pass
