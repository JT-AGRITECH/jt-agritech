...
# VRAI LOGO JT COMPLET - pour remplacer logo Streamlit sur raccourci telephone/tablette
...
# CREE logo.png AVANT set_page_config - FIX DEFINITIF
try:
...
# UTILISE logo.png comme icone - REMPLACE LOGO STREAMLIT
try:
...
# 🔧 FIX LOGO PWA - Remplace logo Streamlit par logo JT-AGRITECH
try:
    import base64 as _b64
    _jt_icon_b64 = ""
    
    # HTML pour favicon + manifest custom
    _pwa_html = '''
    <link rel="icon" type="image/png" href="data:image/png;base64,''' + _jt_icon_b64 + '''">
    <link rel="apple-touch-icon" href="data:image/png;base64,''' + _jt_icon_b64 + '''">
    ...
    # Script pour manifest custom avec logo JT
    _manifest_js = '''
    <script>
    (function(){
      try {
        var iconB64 = "''' + _jt_icon_b64 + '''";
        var manifestData = {
          "name": "JT-AGRITECH",
          ...
          "theme_color": "#225522",
          "description": "Au service des paysans",
          "icons": [{"src": "data:image/png;base64," + iconB64, "sizes": "512x512", "type": "image/png", "purpose": "any maskable"}]
        };
...
\n# MASQUE JS et Streamlit + FORCE VRAI LOGO PWA\ntry:\n    import streamlit.components.v1 as components\n    _html_fix = f"""\n    <script>\n    (function(){\n      try {\n        var b64 = "{_JT_VRAI_LOGO_B64}";\n        var manifest = {"name":"JT AGRITECH","short_name":"JT AGRITECH","start_url":".","display":"standalone","background_color":"#ffffff","theme_color":"#225522","icons":[{"src":"data:image/png;base64,"+b64,"sizes":"512x512","type":"image/png"}]};\n        var blob = new Blob([JSON.stringify(manifest)], {type:"application/json"});\n        var url = URL.createObjectURL(blob);\n        var link = document.querySelector('link[rel="manifest"]');\n        if(!link){link=document.createElement('link'); link.rel='manifest'; document.head.appendChild(link);}\n        link.href = url;\n        document.querySelectorAll('link[rel*="icon"]').forEach(function(l){l.href="data:image/png;base64,"+b64;});\n      }catch(e){}\n    })();\n    </script>\n    <style>header{display:none !important;}footer{display:none !important;}.stDeployButton{display:none !important;}#MainMenu{display:none !important;}div[data-testid="stToolbar"]{display:none !important;}iframe[height="0"]{display:none !important;}</style>\n    """\n    components.html(_html_fix, height=0, width=0)\n    st.markdown("<style>header{display:none !important;}footer{display:none !important;}.stDeployButton{display:none !important;}#MainMenu{display:none !important;}div[data-testid='stToolbar']{display:none !important;}iframe[height='0']{display:none !important;}</style>", unsafe_allow_html=True)\nexcept:\n    pass\n\nwith st.sidebar:
