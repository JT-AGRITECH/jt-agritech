...
# VRAI LOGO JT COMPLET - pour remplacer logo Streamlit sur telephone
...
# CREE logo.png AVANT set_page_config - FIX DEFINITIF REMPLACE STREAMLIT
try:
...
# UTILISE logo.png comme icone - REMPLACE LOGO STREAMLIT PAR VRAI LOGO JT
try:
...
# MASQUE JS visible et Streamlit
try:
